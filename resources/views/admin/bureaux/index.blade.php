...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <!-- Page Header -->
      <x-backend.index_page_header title1="Bureaux" :title="'admin_bureau'" :user="'Admin'" :size="sizeof($bureaux)"/>
      <!-- End Page Header -->
          ...
          <div class="row justify-content-between align-items-center flex-grow-1">
            <div class="col-12 col-md">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-header-title">Bureaux</h5>
              </div>
            </div>
        ...
        <div class="table-responsive datatable-custom">
          <table id="exportDatatable" class="js-datatable table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
            ...
            <tr>
              ...
              <td>
                {{$bureau->administration->name}}
                </td>
              <td>
                @if (empty($bureau->user_id))
                <a role="button" class="btn btn-info btn-sm mr-3" href="{{url('admin_add_chef_bureau_to_bureau/'.$bureau->id)}}">
              ...
              <td>
                {{-- <a role="button" class="btn btn-white btn-sm mr-3" href="{{url('admin_bureau/edit/'.$bureau->id)}}">
                  <i class="bi-pencil-fill me-1"></i> Modifier
                </a> --}}
                <a role="button" class="btn btn-danger btn-sm" href="#" onclick="if(confirm('Etes vous sur de vouloir suprimer le produit '+'{{$bureau->img_tag}}')){deleteProd('{{$bureau->id}}');}else{console.log('false');}">
  ...
  function deleteProd(id){
    window.location.href = "{{url('/')}}/admin_bureau/delete?id="+id;
  }
  </script>

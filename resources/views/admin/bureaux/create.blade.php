  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container mt-4">
        ...
        <form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' enctype="multipart/form-data" method="POST" action="{{url('admin_bureau/store')}}">
              @csrf
...
<!-- Form -->
<div class="row mb-4">
    <label for="roleLabel" class="col-sm-3 col-form-label form-label">administration </label>

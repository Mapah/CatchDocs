...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container mt-4">
        <!-- page header -->
        <x-backend.page_header :user="'Admin'" title="bureaus" :type="'Edit'"/>
        <!-- End page header -->
        <!-- Step Form -->
        <form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' enctype="multipart/form-data" method="POST" action="{{url('admin_save_add_chef_bureau_to_bureau')}}">
              @csrf
              ...
              <div id="addUserStepFormContent">
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                    ...
                    <!-- Form -->
                    <div class="row mb-4">
                        <label for="roleLabel" class="col-sm-3 col-form-label form-label">Selectioner Le chef bureau ({{$bureau->name}}) </label>

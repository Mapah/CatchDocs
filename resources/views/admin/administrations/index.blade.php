            ...
            <div class="col-md-9 mb-2 mb-sm-0">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-no-gutter">
                  ...
                  <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">{{"Administrations"}}</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Aperçu</li>
                </ol>
              </nav>

              <h2 class="page-header-title">{{"Administrations"}}  <span class="badge bg-primary text-light ms-1">{{sizeof($administrations)}}</span></h2>
            </div>


        </div>
      </div>
      {{-- <x-backend.index_page_header title1="Administrations" :title="'administration'" :user="'Admin'" :size="sizeof($administrations)"/> --}}
      <!-- End Page Header -->

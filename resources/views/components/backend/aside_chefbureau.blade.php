      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            <!-- Collapse -->
            <div class="nav-item">
              <a class="nav-link dropdown-toggle {{($segment2=='' && $segment1=='chef_bureau_dashboard')?'active':''}}" href="#navbarVerticalMenuDashboards" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="true" aria-controls="navbarVerticalMenuDashboards">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link {{$segment2==''?'active':''}}" href="{{url('/chef_bureau_dashboard')}}">Default</a>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                ...
                <div id="navProdus" class="nav-collapse collapse"  data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link {{$segment1=='chef_bureau_bureaux' && $segment2==''?'active':''}}" href="{{url('/chef_bureau_bureaux')}}">Aperçu</a>
                  {{-- <a class="nav-link {{$segment1=='chef_bureau_bureau' && $segment2=='create'?'active':''}}" href="{{url('/chef_bureau_bureau/create')}}">Nouveau bureau</a> --}}
                </div>
              </div>
              <!-- End Collapse -->
            ...
            <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link dropdown-toggle {{$segment1=='chef_bureau_document'?'active':''}}" href="#navServ" role="button" data-bs-toggle="collapse" data-bs-target="#navServ" aria-expanded="false" aria-controls="navServ">
                ...
                <div id="navServ" class="nav-collapse collapse"  data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link {{$segment1=='chef_bureau_document' && $segment2==''?'active':''}}" href="{{url('/chef_bureau_document')}}">Aperçu</a>
                  <a class="nav-link {{$segment1=='chef_bureau_document' && $segment2=='create'?'active':''}}" href="{{url('/chef_bureau_document/create')}}">Nouveau Document</a>
                </div>
              </div>
              <!-- End Collapse -->

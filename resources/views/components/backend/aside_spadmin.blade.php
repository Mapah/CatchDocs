      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            <!-- Collapse -->
            <div class="nav-item">
              <a class="nav-link dropdown-toggle {{($segment2=='' && $segment1=='super_admin_dashboard')?'active':''}}" href="#navbarVerticalMenuDashboards" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="true" aria-controls="navbarVerticalMenuDashboards">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link {{$segment2==''?'active':''}}" href="{{url('/super_admin_dashboard')}}">Default</a>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item mt-4">
                  <a class="nav-link dropdown-toggle {{$segment1=='administrations'?'active':''}}" href="#navProdus" role="button" data-bs-toggle="collapse" data-bs-target="#navProjects" aria-expanded="false" aria-controls="navProjects">
                  ...
                  <div id="navProjects" class="nav-collapse collapse"  data-bs-parent="#navbarVerticalMenuPagesMenu">
                    <a class="nav-link {{$segment1=='administrations' && $segment2==''?'active':''}}" href="{{url('/administrations')}}">Aperçu</a>
              ...
              <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link dropdown-toggle {{$segment1=='bureaux'?'active':''}}" href="#navProdus" role="button" data-bs-toggle="collapse" data-bs-target="#navProdus" aria-expanded="false" aria-controls="navProdus">
                ...
                <div id="navProdus" class="nav-collapse collapse"  data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link {{$segment1=='bureaux' && $segment2==''?'active':''}}" href="{{url('/bureaux')}}">Aperçu</a>
                  <a class="nav-link {{$segment1=='bureau' && $segment2=='create'?'active':''}}" href="{{url('/bureau/create')}}">Nouveau bureau</a>
                </div>
              </div>
              <!-- End Collapse -->
            ...
            <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link dropdown-toggle {{$segment1=='document'?'active':''}}" href="#navServ" role="button" data-bs-toggle="collapse" data-bs-target="#navServ" aria-expanded="false" aria-controls="navServ">
                ...
                <div id="navServ" class="nav-collapse collapse"  data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link {{$segment1=='document' && $segment2==''?'active':''}}" href="{{url('/document')}}">Aperçu</a>
                  <a class="nav-link {{$segment1=='document' && $segment2=='create'?'active':''}}" href="{{url('/document/create')}}">Nouveau Document</a>
                </div>
              </div>
              <!-- End Collapse -->
              ...
              <!-- Collapse -->
               <div class="nav-item">
                ...
                <div id="navProfile" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                  ...
                  <a class="nav-link {{$segment1=='users'?'active':''}}" href="{{url('/users')}}">Aperçu</a>
                  {{-- @endhasanyrole --}}
                  <a class="nav-link {{$segment1=='user' && $segment2=='create'?'active':''}}" href="{{url('/user/create')}}">Nouveau Utilisateurs</a>
                </div>
              </div>
              <!-- End Collapse -->

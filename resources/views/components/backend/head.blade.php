<head>
  ...
  <link rel="stylesheet" href="{{asset('backend/vendor/chart.js/dist/Chart.min.css')}}">
  <link rel="stylesheet" href="{{asset('backend/vendor/leaflet/dist/leaflet.css')}}">
  <link rel="stylesheet" href="{{asset('backend/vendor/jsvectormap/dist/css/jsvectormap.min.css')}}">

...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
  ...
  <main id="content" role="main" class="main">
    ...
    <!-- Page Header -->
      <x-backend.index_page_header title1="Bureaux" :title="'bureau'" :user="'Super Admin'" :size="sizeof($bureaux)"/>
      <!-- End Page Header -->
          ...
          <table id="exportDatatable" class="js-datatable table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
            ...
            <tr>
              ...
              <td>
                ...
                <a role="button" class="btn btn-info btn-sm mr-3" href="{{url('add_chef_bureau_to_bureau/'.$bureau->id)}}">
              ...
              <td>
                <a role="button" class="btn btn-white btn-sm mr-3" href="{{url('bureau/edit/'.$bureau->id)}}">
  ...
  function deleteProd(id){
    window.location.href = "{{url('/')}}/bureau/delete?id="+id;
  }
  </script>

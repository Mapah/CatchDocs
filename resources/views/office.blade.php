...
<div class="container"><br><br><br>
        <!-- SEARCH FORM -->
    <form action="{{ url('/searchOffice')}}" method="get" role="search" class="form-inline ml-3">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" name="searchOffice" type="search" id="search" placeholder="Search" aria-label="Search">
